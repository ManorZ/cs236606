...
start_timer:                            # 
.Lfunc_begin0:
	.file	1 "/home/u166450/practice8/compiler-optimization/vectorization/matvector/c/solutions/ivdep" "driver.c"
...
.Ltmp6:
	.loc	1 104 11 prologue_end           # driver.c:104:11
	vxorpd	%xmm0, %xmm0, %xmm0
...
# %bb.6:
	...
	vmovups	.LCPI5_15(%rip), %xmm1          # xmm1 = [5.0E+0,6.0E+0]
                                        # AlignMOV convert to UnAlignMOV 
	vmovups	%xmm1, 880(%rsp)                # AlignMOV convert to UnAlignMOV 
	vmovupd	.LCPI5_16(%rip), %xmm0          # xmm0 = [3.0E+0,4.0E+0]
                                        # AlignMOV convert to UnAlignMOV 
	vmovupd	%xmm0, 864(%rsp)                # AlignMOV convert to UnAlignMOV 
	vmovsd	.LCPI5_17(%rip), %xmm2          # xmm2 = mem[0],zero
	vmovups	%xmm2, 912(%rsp)                # AlignMOV convert to UnAlignMOV 
	vmovups	.LCPI5_18(%rip), %xmm3          # xmm3 = [7.0E+0,8.0E+0]
                                        # AlignMOV convert to UnAlignMOV 
	vmovups	%xmm3, 896(%rsp)                # AlignMOV convert to UnAlignMOV 
	vmovupd	%xmm0, 944(%rsp)                # AlignMOV convert to UnAlignMOV 
	vmovups	.LCPI5_19(%rip), %xmm4          # xmm4 = [1.0E+0,2.0E+0]
                                        # AlignMOV convert to UnAlignMOV 
	vmovups	%xmm4, 928(%rsp)                # AlignMOV convert to UnAlignMOV 
	vmovups	%xmm3, 976(%rsp)                # AlignMOV convert to UnAlignMOV 
	vmovups	%xmm1, 960(%rsp)                # AlignMOV convert to UnAlignMOV 
	vmovups	%xmm4, 1008(%rsp)               # AlignMOV convert to UnAlignMOV 
	vmovups	%xmm2, 992(%rsp)                # AlignMOV convert to UnAlignMOV 
	vmovups	%xmm1, 1040(%rsp)               # AlignMOV convert to UnAlignMOV 
	vmovupd	%xmm0, 1024(%rsp)               # AlignMOV convert to UnAlignMOV 
	vmovups	%xmm2, 1072(%rsp)               # AlignMOV convert to UnAlignMOV 
	vmovups	%xmm3, 1056(%rsp)               # AlignMOV convert to UnAlignMOV 
	vmovupd	%xmm0, 1104(%rsp)               # AlignMOV convert to UnAlignMOV 
	vmovups	%xmm4, 1088(%rsp)               # AlignMOV convert to UnAlignMOV 
	vmovups	%xmm3, 1136(%rsp)               # AlignMOV convert to UnAlignMOV 
	vmovups	%xmm1, 1120(%rsp)               # AlignMOV convert to UnAlignMOV 
	vmovups	%xmm4, 1168(%rsp)               # AlignMOV convert to UnAlignMOV 
	vmovups	%xmm2, 1152(%rsp)               # AlignMOV convert to UnAlignMOV 
	vmovups	%xmm1, 1200(%rsp)               # AlignMOV convert to UnAlignMOV 
	vmovupd	%xmm0, 1184(%rsp)               # AlignMOV convert to UnAlignMOV 
	vmovups	%xmm2, 1232(%rsp)               # AlignMOV convert to UnAlignMOV 
	vmovups	%xmm3, 1216(%rsp)               # AlignMOV convert to UnAlignMOV 
	vmovupd	%xmm0, 1264(%rsp)               # AlignMOV convert to UnAlignMOV 
	vmovups	%xmm4, 1248(%rsp)               # AlignMOV convert to UnAlignMOV 
	vmovups	%xmm3, 1296(%rsp)               # AlignMOV convert to UnAlignMOV 
	vmovups	%xmm1, 1280(%rsp)               # AlignMOV convert to UnAlignMOV 
	vmovups	%xmm4, 1328(%rsp)               # AlignMOV convert to UnAlignMOV 
	vmovups	%xmm2, 1312(%rsp)               # AlignMOV convert to UnAlignMOV 
...
.LBB5_7:                                # =>This Inner Loop Header: Depth=1
	...
	movq	%r13, %r9
	callq	matvec
	.loc	1 116 19                        # driver.c:116:19
	decl	%ebx
	.loc	1 116 5 is_stmt 0               # driver.c:116:5
	jne	.LBB5_7
# %bb.8:
.Ltmp11:
	...
	vsubsd	%xmm2, %xmm1, %xmm1
	vmulsd	.LCPI5_20(%rip), %xmm1, %xmm1
	.loc	1 44 55                         # driver.c:44:55
	vaddsd	%xmm0, %xmm1, %xmm0
	vmovsd	%xmm0, (%rsp)                   # 8-byte Spill
.Ltmp12:
	.loc	1 122 5                         # driver.c:122:5
	movl	$.L.str.2, %edi
	movb	$1, %al
	callq	printf
	vmovsd	.LCPI5_21(%rip), %xmm0          # xmm0 = mem[0],zero
	.loc	1 125 44                        # driver.c:125:44
	vdivsd	(%rsp), %xmm0, %xmm0            # 8-byte Folded Reload
	.loc	1 123 5                         # driver.c:123:5
	movl	$.L.str.3, %edi
	movb	$1, %al
	callq	printf
.Ltmp13:
...
.Linfo_string3:
	.asciz	"/home/u166450/practice8/compiler-optimization/vectorization/matvector/c/solutions/ivdep" # string offset=201
.Linfo_string4:
