...
#define     num_trials    2000000000 // number of x values
#define     num_buckets   1000        // number of buckets in hitogram
...
int main ()
{
   ...
   double* x = (double*)malloc(num_trials*sizeof(double)); //used to assign counters in the historgram 
   int i;
